        ...
        <div id="carouselExampleFade" className="carousel slide carousel-fade" style={{ objectFit: 'contain !important' }}>
          <div className="carousel-inner" style={{ objectFit: 'contain !important' }}>
            ...
            <div className="carousel-item active" id='carousel'>
              <img src="https://source.unsplash.com/random/900x700?pizza" className="d-block w-100" style={{ filter: "brightness{70%}" }} alt="..." />
            </div>
            <div className="carousel-item" id='carousel'>
              <img src="https://source.unsplash.com/random/900x700?burger" className="d-block w-100" style={{ filter: "brightness{30%}" }} alt="..." />
            </div>
            <div className="carousel-item" id='carousel'>
              <img src="https://source.unsplash.com/random/900x700?pastry" className="d-block w-100" style={{ filter: "brightness{10%}" }} alt="..." />
            </div>
          </div>
